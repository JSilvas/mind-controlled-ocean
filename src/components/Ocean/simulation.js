...
var INITIAL_SIZE = 500, // 100 to 1000 (default 250)
  INITIAL_WIND = [5.0, 5.0], // 5 to 25 (default [10.0, 10.0])
  INITIAL_CHOPPINESS = 1.5; // 0 to 2.5 (default 1.5)
...
export function Simulator(canvas, width, height) {
  canvas.width = width;
  ...
  this.render = function(deltaTime, camera) {
